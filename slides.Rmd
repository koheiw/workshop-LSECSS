...
- Analytic methods vary from simple frequency analysis to "deep learning"
    - Complex tools are not always the best choice
    - Training complex model is often expensive

## Challenges in developing text analysis models

Large corpus is often needed to find interesting patters.
...
toks <- tokens(corp) %>% 
        tokens_remove(stopwords('english'), valuetype = 'fixed', padding = TRUE) %>% 
